      ...
      <div class="grid">
        <div class="chicken-taco" style="positon: relative;">
          <div class="chicken-taco-desc">
            ...
            <input type="button" name="button" value="Menu" class="taco-button" style="background-image: url(<?php echo $taco_violet_button ?>)" />
          </div>
          <div class="chicken-taco-img">
